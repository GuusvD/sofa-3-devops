...
public class SprintFactory implements ISprintFactory {
    public ISprint createRegularSprint(int number, Date start, Date end, User user) throws SprintBuildException, PipelineException, AssemblyException {
        return new RegularSprint(number, start, end, user);
    }

    public ISprint createReviewSprint(int number, Date start, Date end, User user) throws SprintBuildException, PipelineException, AssemblyException {
